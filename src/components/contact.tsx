...
const contact = () => {
  ...
  return (
    <div className="max-h-screen"style={{ fontFamily: "Syne" }}>
      <div
        
        className=" pb-10 text-white overflow-x-hidden flex justify-center  items-center justify-between gap-10"
      >
        <div className=" pr-20 ">
          <motion.h1
        ...
        <div className="flex items-center justify-center md:w[30%] ">
          <div className="min-w-xl w-full text-orange-500">
            <motion.h1
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                <button
                  type="submit"
                  className=" text-orange-500 font-light py-4 px-8 rounded-lg hover:bg-white/85 transition-colors text-lg border-1"
                >
                  Submit
                </button>
              </motion.div>
      ...
      <footer style={{fontWeight:700}} className=" flex text-orange-500 justify-between px-90 p-6 border-t-1 text-orange-500 font-lg text-[11px] ">
        <span>EVAYEDON</span>
        <span>© 2026 Evans Ayensu Donkor</span>
