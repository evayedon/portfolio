  ...
  return (
    <>
      <section className="flex items-center justify-center mx-[5%] flex-col">
        ...
        <div className="flex flex-col h-100  mt-20 w-[100%]  justify-center  text-orange-500 ">
          <nav className="flex justify-center gap-[15%] p-2 text-xl font-bold h-20  w-[100%]  mb-10">
            {" "}
