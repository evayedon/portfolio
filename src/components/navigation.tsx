  ...
  <ul className='flex space-x-10 items-center'>
    ...
    <li>
      ...
      <div className="relative h-screen bg-[#333333]">
        ...
        `}
      </style><div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_3px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_3px)] bg-[size:50px_50px] animate-[gridMovement_2s_linear_infinite]">
        ...
        <div className="px-12 pb-6 pt-2 text-sm md:text-base ">
          <pre className="text-gray-300 leading-relaxed">
            <code>
              {'{'}<br/>
              {'  '}
              <span className="text-gray-100">"about_me"</span>: {'{'}<br/>
              {'    '}
              <span className="text-gray-100">"name"</span>: <span className="text-orange-400">"Evans Ayensu"</span>,<br/>
              {'    '}
              <span className="text-gray-100">"career-in-progress"</span>: <span className="text-orange-400">"Software Development"</span>,<br/>
              {'    '}
              <span className="text-gray-100">"current-career-focus"</span>: <span className="text-orange-400">"Fullstack Web Developer"</span><br/>
              {'  '}{'}'}<br/>
              {'}'}
            </code>
          </pre>
